create table activity_platform_content_direction_group
(
    campaign_name                  varchar(255)   not null comment '活动名称',
    media                          varchar(255)   not null comment '媒介平台',
    content_direction              varchar(255)   not null comment '内容方向',
...
INSERT INTO activity_platform_content_direction_group (campaign_name, media, content_direction, cost, exposure_count, exposure_user_count, avg_impression_frequency, click_count, click_user_count, monthly_active_member_count, monthly_active_member_gmv, new_member_acquisition_count, new_member_acquisition_gmv, next_month_active_member_count, next_month_active_member_gmv, next_month_new_member_count, next_month_new_member_gmv) VALUES ('霸王茶姬_202502_214玫瑰水仙上新_霸王茶姬', '小红书', '图文', 15676.23, 8538797, 4583311, 1.86, 967777, 767033, 200853, 15676.23, 31293, 15676.23, 31293, 15676.23, 31293, 15676.23);
